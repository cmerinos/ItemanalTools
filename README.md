...
**Itemanalysis** is an R package for detailed psychometric analysis of items. It provides functions for analyzing:

- **Factorial simplicity and complexity**
- **Item-level associations with external variables**
- **Change detection and reliability of change**
- **Content and substantive validity**
- **Nonparametric item-level tests**
- **Response distribution quality for ordinal items**
